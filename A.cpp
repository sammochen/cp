...
void solve() {
	// when is it good to use mode?
    // well, we know that a euler's path is good. 
    // we also have the luxury of O(n^2), which means that i could potentially start from every node, 
}
